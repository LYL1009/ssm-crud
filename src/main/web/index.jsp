...
<script type="text/javascript">
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area")
            .append("当前" + result.extend.pageInfo.pageNum + "页," +
    ...
    function validate_add_form() {
        ...
        var regName = /(^[A-Za-z0-9_-]{3,12}$)|(^[\u4e00-\u9fa5]{2,5})/;
        if(!regName.test(empName)) {
            //alert("用户名可以是2-5位中文或者6-12位英文和数字的组合！");
            //每一次显示数据之前应该清空这个元素之前的样式
            show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者3-12位英文和数字的组合！");
            return false;
        } else {
    ...
    $("#check_all").click(function () {
        ...
        //建议用prop获取dom原生属性的值；attr获取自定义属性的值
